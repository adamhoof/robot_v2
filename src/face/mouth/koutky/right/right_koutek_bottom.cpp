...
void RightKoutekBottom::move_center()
{
    move_to(port, center, driver_num);
    pos = center;
}

void RightKoutekBottom::move_up_most()
{
    move_to(port, up_most, driver_num);
    pos = up_most;
}

void RightKoutekBottom::move_down_most()
{
...
void RightKoutekBottom::move_down_by(uint16_t moveBy)
{
